...
namespace App\Modules\Academic\AcademicPeriod\Infrastructure\Events;
...
final readonly class LaravelAcademicPeriodActivityPublisher implements AcademicPeriodActivityPublisher
{
    ...
    public function publish(
        ...
        return $this->database->connection()->transaction(function () use (
            ...
            $this->events->dispatch(new SystemActivityOccurred(
                ...
                eventName: 'academic-period.activity.occurred',
                version: 1,
