...
final readonly class ArchiveClassGroup
{
    ...
    public function execute(?Authenticatable $actor, string $classGroupId, string $reason, ?string $correlationId = null): ?ClassGroupData
    {
        return $this->activities->publish(
            actorId: $actor ? (string) $actor->getAuthIdentifier() : null,
            action: 'kelas_rombel.class_group.archived',
            subjectType: 'class_group',
            mutation: fn (): ?ClassGroupData => $this->repository->archiveClassGroup(
                $classGroupId,
