...
namespace App\Modules\Pesantrian\Asrama\Infrastructure\Events;
...
final readonly class LaravelAsramaActivityPublisher implements AsramaActivityPublisher
{
    ...
    public function publish(
        ...
        return $this->database->connection()->transaction(function () use (
            ...
            $this->events->dispatch(new SystemActivityOccurred(
                module: 'Asrama',
                eventName: 'asrama.activity.occurred',
                version: 1,
