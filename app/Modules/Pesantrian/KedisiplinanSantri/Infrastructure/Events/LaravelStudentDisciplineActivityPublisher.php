...
namespace App\Modules\Pesantrian\KedisiplinanSantri\Infrastructure\Events;
...
final readonly class LaravelStudentDisciplineActivityPublisher implements StudentDisciplineActivityPublisher
{
    ...
    public function publish(
        ...
        return $this->database->connection()->transaction(function () use (
            ...
            $this->events->dispatch(new SystemActivityOccurred(
                ...
                eventName: 'kedisiplinan-santri.activity.occurred',
                version: 1,
