...
namespace App\Modules\Pesantrian\PenerimaanSantri\Infrastructure\Events;
...
final readonly class LaravelStudentAdmissionActivityPublisher implements StudentAdmissionActivityPublisher
{
    ...
    public function publish(
        ...
        return $this->database->connection()->transaction(function () use (
            ...
            $this->events->dispatch(new SystemActivityOccurred(
                ...
                eventName: 'penerimaan-santri.activity.occurred',
                version: 1,
