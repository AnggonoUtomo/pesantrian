...
final readonly class ApproveStudentPermit
{
    ...
    public function execute(?Authenticatable $actor, string $id, ?string $reviewNote = null, ?string $correlationId = null): ?StudentPermitData
    {
        ...
        return $this->activities->publish(
            actorId: $actorId,
            action: 'perizinan_santri.permit.approved',
            subjectType: 'student_permit',
            mutation: fn (): ?StudentPermitData => $this->repository->approve($id, $reviewNote, (string) $actorId),
    ...
    private function ensureSubmitted(StudentPermitData $permit): void
    {
        ...
        throw new StudentPermitMutationException(
            'Hanya permohonan izin submitted yang bisa disetujui.',
