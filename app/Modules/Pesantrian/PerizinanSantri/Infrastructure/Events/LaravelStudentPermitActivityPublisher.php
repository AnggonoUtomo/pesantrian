...
namespace App\Modules\Pesantrian\PerizinanSantri\Infrastructure\Events;
...
final readonly class LaravelStudentPermitActivityPublisher implements StudentPermitActivityPublisher
{
    ...
    public function publish(
        ...
        return $this->database->connection()->transaction(function () use (
            ...
            $this->events->dispatch(new SystemActivityOccurred(
                ...
                eventName: 'perizinan-santri.activity.occurred',
                version: 1,
