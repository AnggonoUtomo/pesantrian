...
namespace App\Modules\Pesantrian\PresensiSantri\Infrastructure\Events;
...
final readonly class LaravelStudentAttendanceActivityPublisher implements StudentAttendanceActivityPublisher
{
    ...
    public function publish(
        ...
        return $this->database->connection()->transaction(function () use (
            ...
            $this->events->dispatch(new SystemActivityOccurred(
                ...
                eventName: 'presensi-santri.activity.occurred',
                version: 1,
