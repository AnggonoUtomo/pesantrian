...
namespace App\Modules\Pesantrian\PrestasiSantri\Infrastructure\Events;
...
final readonly class LaravelStudentAchievementActivityPublisher implements StudentAchievementActivityPublisher
{
    ...
    public function publish(
        ...
        return $this->database->connection()->transaction(function () use (
            ...
            $this->events->dispatch(new SystemActivityOccurred(
                ...
                eventName: 'prestasi-santri.activity.occurred',
                version: 1,
