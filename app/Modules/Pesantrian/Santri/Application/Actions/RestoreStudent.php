...
final readonly class RestoreStudent
{
    ...
    public function execute(
        ...
        if ($this->repository->findArchived($studentId) === null) {
            return null;
        }

        return $this->activities->publish(
            actorId: $actor ? (string) $actor->getAuthIdentifier() : null,
            action: 'santri.student.restored',
            subjectType: 'student',
            mutation: fn (): ?StudentData => $this->repository->restore($studentId),
