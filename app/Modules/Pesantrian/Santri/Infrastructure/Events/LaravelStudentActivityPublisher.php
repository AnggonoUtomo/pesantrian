...
namespace App\Modules\Pesantrian\Santri\Infrastructure\Events;
...
final readonly class LaravelStudentActivityPublisher implements StudentActivityPublisher
{
    ...
    public function publish(
        ...
        return $this->database->connection()->transaction(function () use (
            ...
            $this->events->dispatch(new SystemActivityOccurred(
                module: 'Santri',
                eventName: 'santri.activity.occurred',
                version: 1,
