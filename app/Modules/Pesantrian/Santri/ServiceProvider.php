...
use App\Modules\Pesantrian\Santri\Infrastructure\Readers\EloquentActiveStudentReader;
use App\Modules\Pesantrian\Santri\Infrastructure\Readers\EloquentPrimaryStudentGuardianReader;
...
final class ServiceProvider extends FrameworkServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(ActiveStudentReader::class, EloquentActiveStudentReader::class);
        $this->app->bind(PrimaryStudentGuardianReader::class, EloquentPrimaryStudentGuardianReader::class);
    }
