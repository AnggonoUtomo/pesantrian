...
namespace App\Modules\Pesantrian\Tahfidz\Infrastructure\Events;
...
final readonly class LaravelTahfidzActivityPublisher implements TahfidzActivityPublisher
{
    ...
    public function publish(
        ...
        return $this->database->connection()->transaction(function () use (
            ...
            $this->events->dispatch(new SystemActivityOccurred(
                module: 'Tahfidz',
                eventName: 'tahfidz.activity.occurred',
                version: 1,
