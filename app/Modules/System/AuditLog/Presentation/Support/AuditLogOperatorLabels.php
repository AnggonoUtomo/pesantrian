...
final class AuditLogOperatorLabels
{
    ...
    private const ACTIONS = [
        ...
        'kedisiplinan_santri.case.action_assigned' => 'Tindakan pembinaan kedisiplinan ditetapkan',
        'kedisiplinan_santri.case.created' => 'Kasus kedisiplinan dibuat',
        'kedisiplinan_santri.case.reviewed' => 'Kasus kedisiplinan direview',
        'kedisiplinan_santri.case.resolved' => 'Kasus kedisiplinan diselesaikan',
        ...
        'kedisiplinan_santri.case.voided' => 'Kasus kedisiplinan dibatalkan',
