...
final class SettingDefinitionRegistry implements SettingDefinitionRegistrar
{
    ...
    private function baseline(string $appName): array
    {
        return [
            ...
            new SettingDefinitionData('security.password.min_length', SettingType::Integer, 8, 'Panjang minimum password.', 'SystemSetting', 8, 128),
            new SettingDefinitionData('security.password.require_mixed_case', SettingType::Boolean, false, 'Password wajib memakai huruf besar dan kecil.', 'SystemSetting'),
            new SettingDefinitionData('security.password.require_numbers', SettingType::Boolean, false, 'Password wajib memakai angka.', 'SystemSetting'),
            new SettingDefinitionData('security.password.require_symbols', SettingType::Boolean, false, 'Password wajib memakai simbol.', 'SystemSetting'),
