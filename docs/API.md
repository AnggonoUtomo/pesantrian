...
| GET | `/api/v1/pesantrian/prestasi-santri` | `api.v1.pesantrian.prestasi-santri.index` | `prestasi_santri.view` | Tidak | Envelope sukses dengan daftar prestasi santri dan pagination meta |
| POST | `/api/v1/pesantrian/prestasi-santri` | `api.v1.pesantrian.prestasi-santri.store` | `prestasi_santri.record` | Ya | Envelope sukses `201` dengan draft prestasi yang dibuat |
| GET | `/api/v1/pesantrian/prestasi-santri/categories` | `api.v1.pesantrian.prestasi-santri.categories.index` | `prestasi_santri.view` | Tidak | Envelope sukses dengan daftar kategori prestasi |
| POST | `/api/v1/pesantrian/prestasi-santri/categories` | `api.v1.pesantrian.prestasi-santri.categories.store` | `prestasi_santri.manage` | Ya | Envelope sukses `201` dengan kategori prestasi yang dibuat |
| PATCH | `/api/v1/pesantrian/prestasi-santri/categories/{category}` | `api.v1.pesantrian.prestasi-santri.categories.update` | `prestasi_santri.manage` | Ya | Envelope sukses dengan kategori prestasi yang diperbarui |
| PATCH | `/api/v1/pesantrian/prestasi-santri/categories/{category}/archive` | `api.v1.pesantrian.prestasi-santri.categories.archive` | `prestasi_santri.archive` | Ya | Envelope sukses dengan kategori prestasi yang diarsipkan tanpa menghapus histori prestasi |
| PATCH | `/api/v1/pesantrian/prestasi-santri/{achievement}` | `api.v1.pesantrian.prestasi-santri.update` | `prestasi_santri.record` | Ya | Envelope sukses dengan draft prestasi yang diperbarui dan revision tercatat |
| GET | `/api/v1/pesantrian/prestasi-santri/{achievement}` | `api.v1.pesantrian.prestasi-santri.show` | `prestasi_santri.view` | Tidak | Envelope sukses dengan detail prestasi, snapshot, lifecycle, dan revision history |
| PATCH | `/api/v1/pesantrian/prestasi-santri/{achievement}/revise` | `api.v1.pesantrian.prestasi-santri.revise` | `prestasi_santri.verify` | Ya | Envelope sukses dengan prestasi berstatus needs_revision, alasan revisi, revision, dan audit tercatat |
| PATCH | `/api/v1/pesantrian/prestasi-santri/{achievement}/submit` | `api.v1.pesantrian.prestasi-santri.submit` | `prestasi_santri.record` | Ya | Envelope sukses dengan draft prestasi berstatus submitted |
| PATCH | `/api/v1/pesantrian/prestasi-santri/{achievement}/verify` | `api.v1.pesantrian.prestasi-santri.verify` | `prestasi_santri.verify` | Ya | Envelope sukses dengan prestasi berstatus verified sebagai riwayat resmi santri |
| PATCH | `/api/v1/pesantrian/prestasi-santri/{achievement}/void` | `api.v1.pesantrian.prestasi-santri.void` | `prestasi_santri.archive` | Ya | Envelope sukses dengan prestasi berstatus void tanpa menghapus data, alasan pembatalan, revision, dan audit tercatat |
...
| PATCH | `/api/v1/pesantrian/student-discipline-cases/{case}/resolve` | `api.v1.pesantrian.student-discipline-cases.resolve` | `kedisiplinan_santri.resolve` | Ya | Envelope sukses dengan kasus berstatus resolved, catatan penyelesaian, actor penyelesai, revision, dan audit tercatat |
...
| PATCH | `/api/v1/pesantrian/student-discipline-cases/{case}/void` | `api.v1.pesantrian.student-discipline-cases.void` | `kedisiplinan_santri.resolve` | Ya | Envelope sukses dengan kasus berstatus void, alasan pembatalan, actor pembatal, revision, dan audit tercatat tanpa menghapus data |
