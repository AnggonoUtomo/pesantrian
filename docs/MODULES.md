...
| 17 | `Pesantrian/PrestasiSantri` | Prestasi | Catatan prestasi, kategori, tingkat, tanggal/periode, lampiran bukti | Santri contract, Document bila diperlukan | Active - backend read/list ready |
