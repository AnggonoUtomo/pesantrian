...
| `Pesantrian/PresensiSantri` | Presensi Santri | Active - data foundation ready | Sesi presensi santri, detail kehadiran, status hadir/izin/sakit/alfa/terlambat, revisi, dan rekap awal. |
...
| 14 | `Pesantrian/PresensiSantri` | Presensi Santri | Presensi kegiatan santri di luar/bersama akademik formal | Santri contract, KelasRombel contract, Asrama contract bila diperlukan | Active - data foundation ready |
