...
| `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Active | Backend read/list, create/update API, dan penempatan santri untuk kelas, rombel, kurikulum minimum, dan wali kelas. |
...
| 11 | `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Kelas, rombel, kurikulum minimum, penempatan santri, dan wali kelas | Organization, AcademicPeriod, Santri contract, HumanResource contract | Active - backend placement API |
