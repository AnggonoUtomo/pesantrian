...
| `Pesantrian/Tahfidz` | Tahfidz / Hafalan | Active - QA browser selesai | Program, target, setoran, murojaah, review, dan progres hafalan santri. |
...
| 13 | `Pesantrian/Tahfidz` | Tahfidz / Hafalan | Target hafalan, setoran, murojaah, capaian, pembimbing tahfidz | Santri contract, HumanResource contract, AcademicPeriod bila diperlukan | Active - QA browser desktop/mobile selesai |
...
| 15 | `Pesantrian/PerizinanSantri` | Perizinan Santri | Izin keluar/pulang/sakit, approval ringan, status kembali, riwayat izin | Santri contract, WaliSantri snapshot/query bila tersedia, HumanResource contract bila diperlukan, PresensiSantri read-only consumer | Active - increment 13 integration readiness |
| 16 | `Pesantrian/KedisiplinanSantri` | Pelanggaran / Kedisiplinan | Catatan pelanggaran, kategori, poin/tingkat, tindakan pembinaan, riwayat penyelesaian | Santri contract, HumanResource contract, PresensiSantri/PerizinanSantri read-only candidate, WaliSantri bila diperlukan | Active - data foundation ready |
| 17 | `Pesantrian/PrestasiSantri` | Prestasi | Catatan prestasi, kategori, tingkat, tanggal/periode, lampiran bukti | Santri contract, Document bila diperlukan | Active - skeleton dan permission ready |
