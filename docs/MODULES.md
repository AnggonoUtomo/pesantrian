...
| `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Active | Backend read/list dan create/update API untuk kelas, rombel, kurikulum minimum, penempatan santri, dan wali kelas. |
...
| 11 | `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Kelas, rombel, kurikulum minimum, penempatan santri, dan wali kelas | Organization, AcademicPeriod, Santri contract, HumanResource contract | Active - backend create/update API |
