...
| 16 | `Pesantrian/KedisiplinanSantri` | Pelanggaran / Kedisiplinan | Catatan pelanggaran, kategori, poin/tingkat, tindakan pembinaan, riwayat penyelesaian | Santri contract, HumanResource contract, PresensiSantri/PerizinanSantri read-only candidate, WaliSantri bila diperlukan | Active - documentation baseline ready |
