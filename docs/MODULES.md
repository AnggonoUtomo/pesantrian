...
| `Pesantrian/Asrama` | Asrama | Active - backend read/list | Asrama, kamar, kapasitas, musyrif, penempatan santri, transfer kamar, occupancy, dan riwayat placement. |
...
| 12 | `Pesantrian/Asrama` | Asrama | Dormitory, room, occupancy, placement, musyrif relation, placement history | Organization, Santri contract, HumanResource contract | Active - backend read/list |
