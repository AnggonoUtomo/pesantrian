...
| `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Active | Backend read/list, create/update API, penempatan santri, wali kelas, archive/restore rombel, dan demo seeder. |
...
| 11 | `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Kelas, rombel, kurikulum minimum, penempatan santri, dan wali kelas | Organization, AcademicPeriod, Santri contract, HumanResource contract | Active - demo seeder |
