...
| `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Active | Data foundation untuk kelas, rombel, kurikulum minimum, penempatan santri, dan wali kelas. |
...
| 11 | `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Kelas, rombel, kurikulum minimum, penempatan santri, dan wali kelas | Organization, AcademicPeriod, Santri contract, HumanResource contract | Active - data foundation |
