...
| `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Active | Backend read/list, create/update API, penempatan santri, wali kelas, archive/restore rombel, demo seeder, UI list/detail, dan form mutation utama. |
...
| 11 | `Academic/KelasRombel` | Kelas / Rombel / Kurikulum | Kelas, rombel, kurikulum minimum, penempatan santri, dan wali kelas | Organization, AcademicPeriod, Santri contract, HumanResource contract | Active - UI mutation utama, browser QA manual tersisa |
