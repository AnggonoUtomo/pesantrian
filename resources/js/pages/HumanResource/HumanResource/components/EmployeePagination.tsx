...
type Props = {
    meta: HumanResourceEmployeePageProps['employees']['meta'];
    pagination: HumanResourceEmployeePageProps['pagination'];
    ...
    return (
        <div className="flex flex-col gap-3 border-t pt-4 text-sm sm:flex-row sm:items-center sm:justify-between">
            <p className="text-foreground/65">
                Menampilkan {firstItem}-{lastItem} dari {meta.total} employee ·
            ...
            <div className="flex flex-wrap items-center gap-2">
                ...
                >
                    <SelectTrigger
                        aria-label="Jumlah employee per halaman"
                        className="w-28"
                    >
                        <SelectValue />
                    </SelectTrigger>
