...
export function KedisiplinanSantriActionBar({
    canManage,
    onCreate,
}: Props) {
    return (
        <div className="flex flex-col gap-3 rounded-2xl border bg-background/70 p-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p className="text-sm text-foreground/65">
                    Buat draft kasus dari data santri aktif. Submit, review,
                    tindakan pembinaan, penyelesaian, dan pembatalan dilakukan
                    lewat aksi lifecycle.
                </p>
            </div>
            {canManage ? (
