...
export function KedisiplinanTextField({
    id,
    label,
    value,
    error,
    ...
    return (
        <div className="space-y-2">
            ...
            />
            {error ? <KedisiplinanFieldError message={error} /> : null}
        </div>
    );
}

export function KedisiplinanTextareaField({
    id,
    label,
    value,
    error,
...
export function KedisiplinanSelectField({
    id,
    label,
    value,
    error,
...
export function KedisiplinanFieldError({ message }: { message: string }) {
    return (
