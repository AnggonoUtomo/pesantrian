...
export function SantriRestoreDialog({ open, student, onOpenChange }: Props) {
    ...
    const submit = (event: FormEvent<HTMLFormElement>) => {
        ...
        form.patch(
            routeOr(
                `/pesantrian/students/${student.id}/restore`,
            ...
            <DialogContent>
                <DialogHeader>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <DialogTitle>Pulihkan santri</DialogTitle>
                            <DialogDescription className="mt-1">
                                Data santri akan kembali tampil pada daftar
                                aktif.
                            </DialogDescription>
                        </div>
                    </div>
                ...
                <form className="space-y-4" onSubmit={submit}>
                    <p className="rounded-lg border bg-muted/40 p-3 text-sm">
                        Pulihkan <strong>{student?.full_name}</strong> ke
                        daftar aktif?
                    </p>
                    <div className="space-y-2">
                        <Label htmlFor="student-restore-reason">
                            Alasan pemulihan
                        </Label>
                        <Input
                            id="student-restore-reason"
